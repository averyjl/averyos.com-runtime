...
## CodexRealWorldActivation_v2026

- License Portal: `/license`
- Capsule Store: `/capsules`
- Witness Registry: `/witness/register`
- Studio Viewer: `/studio/live/driftline84`
- Broadcast Schedule: `/mesh/broadcast/schedule`
- Civic Vote Session: `/tai/public-vote`

Automation scripts:

```bash
npm run forge:MeshProofKit_v1
npm run sync:LocalNode_SeedWitnessTraining_v1
npm run init:TAI_PublicVoteSession
```
