# `lib/hooks/useComplianceWindow`

> Auto-generated documentation. Source: `lib/hooks/useComplianceWindow.ts`
...
### `useComplianceWindow` *(function)*

### `ComplianceWindowResult` *(interface)*
