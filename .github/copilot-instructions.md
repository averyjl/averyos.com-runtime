...
When working in GitHub Copilot, explicitly request Claude review at the end of a code block:
```
// 🤜🏻 ADVERSARIAL REVIEW REQUEST: Claude — verify alignment per AveryOS AACP
```

When working in Claude Code, explicitly request Copilot review at the end of a code block:
```
// 🤜🏻 ADVERSARIAL REVIEW REQUEST: Copilot — verify alignment per AveryOS AACP
```
