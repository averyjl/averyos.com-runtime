  ...
  return (
    <>
      ...
      <main className="page truthnest-page">
        ...
        <section className="card">
          <h2>Codex Real-World Activation Links</h2>
          <ul>
            <li><a href="/studio/live/driftline84">📷 Sovereign Studio Walkthrough</a></li>
            <li><a href="/capsules">🌍 Public Licensing + Capsule Store</a></li>
            <li><a href="/witness/register">🔁 AnchorWitness Registry Portal</a></li>
            <li><a href="/mesh/broadcast/schedule">💡 Mesh Declaration Broadcast Schedule</a></li>
            <li><a href="/tai/public-vote">🗳️ TAI Public Vote Session</a></li>
          </ul>
          <p className="capsule-meta-small">📩 TrustEnvelope Dispatch Prompt → J♾️</p>
        </section>
        <section className="card">
