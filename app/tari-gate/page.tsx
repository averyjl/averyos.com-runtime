...
export const metadata: Metadata = {
  ...
  description: "Truth Anchored Revenue Initiative (TARI) Licensing Portal. $1.00/hit Truth-Packet model. Retroactive liability for unlicensed IP ingestion. AveryOS™ Commercial License v2026.",
  robots: { index: true, follow: true },
  openGraph: {
    title: "TARI Gate — Licensing Portal • AveryOS™",
    type: "website",
    url: "https://averyos.com/tari-gate",
  },
  alternates: { canonical: "https://averyos.com/tari-gate" },
};

const G = "#ffffff";

export default function TariGatePage() {
  return (
    <main className="page">
      <AnchorBanner />
