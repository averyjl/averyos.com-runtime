...
export const metadata: Metadata = {
  ...
  description: "AveryOS™ LawCodex — Sovereign TARI Disclosure, Dynamic Truth Multiplier rules, forensic IP enforcement, and VaultChain jurisdiction. All kernel interactions are notarized.",
  robots: { index: true, follow: true },
  openGraph: {
    title: "LawCodex — AveryOS™ Sovereign Legal Code",
    type: "website",
    url: "https://averyos.com/lawcodex",
  },
  alternates: { canonical: "https://averyos.com/lawcodex" },
};
...
export default function LawCodexPage() {
  return (
    <main className="page">
      <AnchorBanner />
      ...
      >
        ...
        <div style={{ background: "rgba(9, 16, 34, 0.75)", border: "1px solid rgba(248, 113, 113, 0.3)", borderRadius: "10px", padding: "1.5rem", marginBottom: "1.25rem" }}>
          ...
          <p style={{ color: "rgba(238, 244, 255, 0.85)" }}>
            ...
            <code style={{ background: "rgba(120, 148, 255, 0.15)", padding: "0.1rem 0.4rem", borderRadius: "4px", fontSize: "0.92rem" }}>
        ...
        <div style={{ background: "rgba(9, 16, 34, 0.75)", border: "1px solid rgba(248, 113, 113, 0.3)", borderRadius: "10px", padding: "1.5rem", marginBottom: "1.25rem" }}>
          ...
          <ul style={{ color: "rgba(238, 244, 255, 0.85)", lineHeight: "2.1" }}>
            ...
            <li>
              ...
              <code style={{ background: "rgba(120, 148, 255, 0.15)", padding: "0.1rem 0.4rem", borderRadius: "4px", fontSize: "0.85rem" }}>
        ...
        <div style={{ background: "rgba(36, 58, 140, 0.18)", border: "1px solid rgba(120, 148, 255, 0.4)", borderRadius: "10px", padding: "1.5rem" }}>
          ...
          <p style={{ color: "rgba(238, 244, 255, 0.65)", fontSize: "0.82rem", marginTop: "0.75rem", marginBottom: 0, fontStyle: "italic" }}>
      ...
      >
        <h2 style={{ color: "rgba(122, 170, 255, 0.95)", marginTop: 0, fontSize: "1.4rem" }}>
