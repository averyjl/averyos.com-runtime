...
export const metadata: Metadata = {
  title: "LawCodex • AveryOS Constitution v1.17",
  description:
    "AveryOS Constitution v1.17 — Sovereign law, Dynamic Truth Multiplier, and TARI disclosure. All kernel interactions are notarized on the VaultChain.",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "LawCodex • AveryOS Constitution v1.17",
    description:
      "AveryOS Constitution v1.17 — Sovereign law governing all AveryOS kernel interactions, notarized on the VaultChain.",
    type: "website",
    url: pageUrl,
  },
};
